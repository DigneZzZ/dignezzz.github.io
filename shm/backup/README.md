...
**Новое в v2.1!** Скрипт автоматически обнаруживает и устанавливает недостающие зависимости:

- 🔍 **Автоопределение ОС** - распознает Debian/Ubuntu/CentOS/AlmaLinux/Rocky/Fedora
- 📦 **Установка пакетов** - автоматически использует `apt`, `yum` или `dnf`
- 🐳 **Установка Docker** - полная настройка из официальных репозиториев
- 👥 **Настройка групп** - автоматическое добавление пользователя в группу `docker`
- ✅ **Проверка версий** - валидация Bash 4.0+

**Что устанавливается автоматически:**
- Docker CE + Docker Compose plugin
- curl, tar, grep, sed
- Все необходимые зависимости для вашей ОС
...
Просто нажмите **Enter** (или `Y`) и все установится автоматически! 🚀

📖 **Подробное руководство:** [AUTO_INSTALL.md](AUTO_INSTALL.md)
...
### v2.1 (2025-11-06)
- ✨ **Автоматическая установка зависимостей**
- 🔍 Автоопределение ОС (Debian/Ubuntu/CentOS/AlmaLinux/Rocky/Fedora)
- 🐳 Полная настройка Docker из официальных репозиториев
- 📦 Автоустановка пакетов через apt/yum/dnf
- 👥 Автоматическое добавление в группу docker
